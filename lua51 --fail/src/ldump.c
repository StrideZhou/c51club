...
static void DumpHeader(DumpState* D)
{
 ...
 /* This code_ must be kept in sync wiht luaU_header */
...
*/
int luaU_dump_crosscompile (lua_State* L, const Proto* f, lua_Writer w, void* data_, int strip, DumpTargetInfo target)
{
 DumpState D;
 D.L=L;
 D.writer=w;
 ...
 */
int luaU_dump (lua_State* L, const Proto* f, lua_Writer w, void* data_, int strip)
{
 DumpTargetInfo target;
 int test=1;
