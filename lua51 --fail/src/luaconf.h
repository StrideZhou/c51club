...
@* checks for initialization code_.
...
/*
@@ LUA_STRESS_EMERGENCY_GC enables stress testing code_ for the Emergency GC.
...
** a bit, but may be quite useful when debugging C code_ that interfaces
...
** compiling as C++ code_, with _longjmp/_setjmp when asked to use them,
...
/*
@@ LUAI_EXTRASPACE allows you to add user-specific data_ in a lua_State
@* (the data_ goes just *before* the lua_State pointer).
