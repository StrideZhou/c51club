...
const TValue* luaR_findentry(void *data_, const char *strkey, luaR_numkey numkey, unsigned *ppos);
void luaR_getcstr(char *dest, const TString *src, size_t maxsize);
void luaR_next(lua_State *L, void *data_, TValue *key, TValue *val);
void* luaR_getmeta(void *data_);
